...
| [x] | 骨架屏 | Skeleton | skeleton | 加载占位，多形状组合 |
| [x] | 头像 | Avatar | avatar | 图片/文字，形状/尺寸/叠加 |
| [x] | 评分 | Rate | rate | 星级评分，支持半选/只读 |
...
2026-08-04 | Skeleton | feat(skeleton): 添加赛博朋克风格骨架屏组件及预览页面 | text/circle/rect/扫描流光/组合
